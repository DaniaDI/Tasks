             ...
             <div class="bg-light rounded-4 py-5 px-4 px-md-5">
                 ...
                 <div class="row gx-5 justify-content-center">
                     <div class="col-lg-8 col-xl-6">
                         ...
                         <!-- to get an API token!-->
                         <form enctype="multipart/form-data" id="contactForm" data-sb-form-api-token="API_TOKEN"
                             method='POST' action="{{ route('personal.postconnect') }}">
                             <!-- Name input-->
                             @csrf
                             ...
                             <!-- Phone number input-->
                             <div class="form-floating mb-3">
                                 <input class="form-control @error('phone') is-invalid  @enderror " name="phone" id="phone" type="tel"
                             ...
                             <!-- Message input-->
                             <div class="form-floating mb-3">
                                 <textarea class="form-control  @error('area') is-invalid  @enderror " name="area" id="message" type="text" placeholder="Enter your message here..."
